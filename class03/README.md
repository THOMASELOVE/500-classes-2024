...
1. Today's class was pre-recorded. The video (67 minutes long) is now posted so that you can watch it or download it. See your email or [Canvas](https://canvas.case.edu/) to access the recording (if you use Canvas, select **Zoom** then **Cloud Recordings**).
